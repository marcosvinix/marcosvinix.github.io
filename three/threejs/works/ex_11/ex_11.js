...
var cylinderGeometry3 = new THREE.CylinderGeometry(0.05, 0.05, 1.0, 25);
var cylinderMaterial3 = new THREE.MeshPhongMaterial({ color: 'rgb(255,100,255)' });
var cylinder3 = new THREE.Mesh(cylinderGeometry3, cylinderMaterial3);
cylinder3.position.set(0, 0.5, 0);
cylinder3.rotation.set(0, 0, Math.PI / 2); 
cylinder2.add(cylinder3)

var cylinderGeometry4 = new THREE.CylinderGeometry(0.05, 0.05, 1.0, 25);
var cylinderMaterial4 = new THREE.MeshPhongMaterial({ color: 'rgb(100,255,255)' });
var cylinder4 = new THREE.Mesh(cylinderGeometry4, cylinderMaterial4);
cylinder4.position.set(0, -0.5, 0);
cylinder4.rotation.set(Math.PI / 2, 0, 0);
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    cylinder4.matrix.identity(); // reset matrix
    ...
    cylinder3.matrix.multiply(mat4.makeRotationY(angle3)); 
    cylinder3.matrix.multiply(mat4.makeTranslation(0.0, 0.5, 0.0)); 
    cylinder3.matrix.multiply(mat4.makeRotationX(Math.PI / 2)); 

    cylinder4.matrix.identity(); 
    cylinder4.matrix.multiply(mat4.makeRotationY(-angle3)); 
    cylinder4.matrix.multiply(mat4.makeTranslation(0.0, -0.5, 0.0)); 
    cylinder4.matrix.multiply(mat4.makeRotationX(Math.PI / 2)); 
